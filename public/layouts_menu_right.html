  ...
  <body class="menu-position-side menu-side-right full-screen">
    <div class="all-wrapper solid-bg-all">
      ...
      <div class="layout-w">
        ...
        START - Main Menu
        -------------------->
        <div class="menu-w color-scheme-light color-style-default menu-position-side menu-side-right menu-layout-compact sub-menu-style-over sub-menu-color-bright selected-menu-color-light menu-activated-on-hover menu-has-selected-link">
          <div class="logo-w">
