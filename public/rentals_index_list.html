          ...
          <div class="property-items as-list">
            ...
            <div class="property-item">
              ...
              <div class="item-info">
                ...
                <h3 class="item-title">
                  <a href="rentals_single.html">Premier ski-out property on Aspen Mtn, beautiful modern finishes</a>
                </h3>
                <div class="item-reviews">
                  <div class="reviews-stars">
                    <select class="item-star-rating">
                ...
                <div class="item-price-buttons">
                  <div class="item-price">
                    <strong>$280</strong><span>/per night</span>
                  </div>
                  <div class="item-buttons">
                    <a class="btn btn-outline-primary" href="rentals_single.html"><span>Details</span><i class="os-icon os-icon-arrow-2-right"></i></a>
                  </div>
            ...
            <div class="property-item">
              ...
              <div class="item-info">
                ...
                <div class="item-price-buttons">
                  <div class="item-price">
                    <strong>$179</strong><span>/per night</span>
                  </div>
                  <div class="item-buttons">
                    <a class="btn btn-outline-primary" href="rentals_single.html"><span>Details</span><i class="os-icon os-icon-arrow-2-right"></i></a>
                  </div>
