...
<html>
  ...
  <div class="element-box">
    ...
    <div class="element-box-content">
      <div class="container-fluid">
        <div class="row">
          <div class="example-column col-1">
            <code>.col-1</code>
          </div>
          <div class="example-column col-1">
            <code>.col-1</code>
        ...
        <div class="row">
          <div class="example-column col-2">
            <code>.col-2</code>
          </div>
          <div class="example-column col-2">
            <code>.col-2</code>
        ...
        <div class="row">
          <div class="example-column col-3">
            <code>.col-3</code>
          </div>
          <div class="example-column col-3">
            <code>.col-3</code>
        ...
        <div class="row">
          <div class="example-column col-4">
            <code>.col-4</code>
          </div>
          <div class="example-column col-4">
            <code>.col-4</code>
        ...
        <div class="row">
          <div class="example-column col-5">
            <code>.col-5</code>
          </div>
          <div class="example-column col-7">
            <code>.col-7</code>
          </div>
        </div>
        <div class="row">
          <div class="example-column col-6">
            <code>.col-6</code>
          </div>
          <div class="example-column col-6">
            <code>.col-6</code>
        ...
        <div class="row">
          <div class="example-column col-12">
            <code>.col-12</code>
          </div>
        </div>
      </div>
  ...
  <div class="element-box">
    ...
    <div class="form-desc">
      Bootstrap includes a powerful mobile-first flexbox grid system for building layouts of all shapes and sizes. It’s based on a 12 column layout and has multiple tiers, one for each <a href="https://v4-alpha.getbootstrap.com/layout/overview/#responsive-breakpoints">media query range</a>. You can use it with Sass mixins or our predefined classes. You can read more about bootstrap grid by <a href="https://v4-alpha.getbootstrap.com/layout/grid/">clicking here</a>.
    </div>
    <div class="element-box-content">
      <table class="table-v2 table table-bordered table-striped table-responsive">
        <thead>
          <tr>
            <th></th>
            ...
            <th class="text-center">
              Double Extra large<br><small>≥1450px</small>
            </th>
          </tr>
        </thead>
        <tbody>
