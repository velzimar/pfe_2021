              ...
              <div class="support-index">
                <div class="support-tickets">
                  <div class="support-tickets-header">
                    ...
                    <div class="tickets-filter">
                      <div class="form-group mr-3">
                        <label class="d-none d-md-inline-block mr-2">Status</label><select class="form-control-sm">
                          <option>
                            Closed
                          </option>
                          <option>
                      ...
                      <div class="form-check stick-right">
                        <label class="form-check-label"><span>Private</span><input type="checkbox"></label>
                      </div>
                    </div>
                  </div>
                  <div class="support-ticket ">
                    ...
                    <div class="st-foot">
                      <span class="label">Agent:</span><a class="value with-avatar" href="#"><img alt="" src="img/avatar1.jpg"><span>John Mayers</span></a><span class="label">Updated:</span><span class="value">Today 10:00am</span>
                    </div>
                  </div>
                  <div class="support-ticket ">
                    <div class="st-meta">
                    ...
                    <div class="st-foot">
                      <span class="label">Agent:</span><a class="value with-avatar" href="#"><img alt="" src="img/avatar1.jpg"><span>John Mayers</span></a><span class="label">Updated:</span><span class="value">Jan 24th 8:14am</span>
                    </div>
                  </div>
                  <div class="support-ticket active">
                    ...
                    <div class="st-foot">
                      <span class="label">Agent:</span><a class="value with-avatar" href="#"><img alt="" src="img/avatar1.jpg"><span>John Mayers</span></a><span class="label">Updated:</span><span class="value">Jan 12th 7:32am</span>
                    </div>
                  </div>
                  <div class="support-ticket ">
                    <div class="st-meta">
                      <div class="badge badge-primary-inverted">
                        Shopping
                      </div>
                      <i class="os-icon os-icon-ui-09"></i>
                      <div class="status-pill yellow"></div>
                    ...
                    <div class="st-foot">
                      <span class="label">Agent:</span><a class="value with-avatar" href="#"><img alt="" src="img/avatar1.jpg"><span>John Mayers</span></a><span class="label">Updated:</span><span class="value">Yesterday 9:42am</span>
                    </div>
                  </div>
                  <div class="support-ticket ">
                    <div class="st-meta">
                    ...
                    <div class="st-foot">
                      <span class="label">Agent:</span><a class="value with-avatar" href="#"><img alt="" src="img/avatar1.jpg"><span>John Mayers</span></a><span class="label">Updated:</span><span class="value">Feb 17th 11:42am</span>
                    </div>
                  </div>
                  <div class="support-ticket ">
                    <div class="st-meta">
                    ...
                    <div class="st-foot">
                      <span class="label">Agent:</span><a class="value with-avatar" href="#"><img alt="" src="img/avatar1.jpg"><span>John Mayers</span></a><span class="label">Updated:</span><span class="value">Mar 10th 3:12pm</span>
                    </div>
                  </div>
                    ...
                    <div class="ticket-thread">
                      <div class="ticket-reply">
                        ...
                        <div class="ticket-reply-content">
                          <p>
                            Hi. For the featured recipe banner feature, I'm able to enable it to show selected recipe and post on the feature recipe banner.
                          </p>
                          <p>
                      ...
                      <div class="ticket-reply">
                        <div class="ticket-reply-info">
                          <a class="author with-avatar" href="#"><img alt="" src="img/avatar1.jpg"><span>John Mayers</span></a><span class="info-data"><span class="label">replied on</span><span class="value">April 9th, 2017 at 7:41am</span></span>
                          <div class="actions" href="#">
                            <i class="os-icon os-icon-ui-46"></i>
                            <div class="actions-list">
                              <a href="#"><i class="os-icon os-icon-ui-49"></i><span>Edit</span></a><a href="#"><i class="os-icon os-icon-ui-09"></i><span>Mark Private</span></a><a href="#"><i class="os-icon os-icon-ui-03"></i><span>Favorite</span></a><a class="danger" href="#"><i class="os-icon os-icon-ui-15"></i><span>Delete</span></a>
