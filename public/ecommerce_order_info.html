    ...
    <div class="order-box">
      <div class="order-details-box">
        <div class="order-main-info">
          <span>Order #</span><strong>KHD8374</strong>
        </div>
        <div class="order-sub-info">
          <span>Placed On</span><strong>January 14th, 2019</strong>
        </div>
      </div>
      <div class="order-controls">
        <form class="form-inline">
          <div class="form-group">
            <label for="">Order Status</label><select class="form-control form-control-sm">
              <option>
                Shipped
              </option>
              <option>
        ...
        <div class="table-responsive">
          <table class="table table-lightborder">
            ...
            <tbody>
              <tr>
                <td>
                  <div class="product-image" style="background-image: url(img/product7.jpg)"></div>
                </td>
                <td>
                  <div class="product-name">
                    Palissade Cone Chair
                  </div>
                  <div class="product-details">
                    <span>Color: </span><strong> Gold Coral</strong>
                      ...
                      <div class="input-group">
                        <div class="input-group-prepend input-group-sm">
                          <div class="input-group-text">
                            <div class="os-icon os-icon-minus2"></div>
                          </div>
                        </div>
                        <input class="form-control form-control-sm" type="text" value="2">
              ...
              <tr>
                <td>
                  <div class="product-image" style="background-image: url(img/product8.jpg)"></div>
                </td>
                <td>
                  <div class="product-name">
                    Serassi Living Room Sofa
                  </div>
                  <div class="product-details">
      ...
      <div class="order-foot">
        <div class="row">
          ...
          <div class="col-md-5 offset-md-1">
            ...
            <div class="order-summary-row">
              <div class="order-summary-label">
                <span>Shipping</span><strong>Next Day Air</strong>
              </div>
              <div class="order-summary-value">
                $29
              </div>
  ...
  <div class="col-md-4">
    <div class="ecommerce-customer-info">
      <div class="ecommerce-customer-main-info">
        <div class="ecc-avatar" style="background-image: url(img/avatar1.jpg)"></div>
        <div class="ecc-name">
          Michael Collins
        </div>
      </div>
      <div class="ecommerce-customer-sub-info">
        <div class="ecc-sub-info-row">
          ...
          <div class="sub-info-value">
            <a href="#">michael.collins@gmail.com</a>
          </div>
        </div>
        <div class="ecc-sub-info-row">
          <div class="sub-info-label">
      ...
      <div class="os-tabs-controls">
        <ul class="nav nav-tabs">
          <li class="nav-item">
            <a class="nav-link active" data-toggle="tab" href="#tab_overview"> Billing</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#tab_sales"> Shipping</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#tab_sales"> Order History</a>
          </li>
        </ul>
      </div>
      <div class="tab-content">
        ...
        <div class="ecc-sub-info-row">
          ...
          <div class="sub-info-value">
            <img alt="" src="img/mastercard.png" style="width: auto; height: 40px;"><span>ending 8374</span>
          </div>
        </div>
      </div>
    </div>
