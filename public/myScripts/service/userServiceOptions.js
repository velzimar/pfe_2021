...
$("#post-btn").click(function (e) {
    ...
    if(all_choices.length === 0){
        ...
        $.ajax({
            type: "POST",
            url: "/serviceOptions/admin/new",//post how you get this URL please...
    ...
    $.ajax({
        type: "POST",
        url: "/serviceOptions/admin/new",//post how you get this URL please...
        data: {array: all_choices, service_id: service_id, user_id: user_id},//jQ will sort this out for you
        success: function (response) {
            console.log('aaaaa');
            if (response.success) {
                console.log('sucess');
