...
function initMap() {
    ...
    map.addListener("click", (event) => {
        ...
        document.getElementById("registration_form_longitude").value = event.latLng.lng().toFixed(7);
        document.getElementById("registration_form_latitude").value = event.latLng.lat().toFixed(8);
