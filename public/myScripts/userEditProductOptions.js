...
$("#post-btn").click(function (e) {
    ...
    if (all_choices.length === 0) {
        $.ajax({
            type: "POST",
            url: "/productOptions/admin/edit",//post how you get this URL please...
    ...
    $.ajax({
        type: "POST",
        url: "/productOptions/admin/edit",//post how you get this URL please...
        data: {array: all_choices, product_id: product_id, option_id: parseInt(option_id), user_id:user_id},//jQ will sort this out for you
        success: function (response) {
            console.log('a2');
            if (response.success) {
                console.log('sucess');
