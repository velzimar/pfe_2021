...
<html>
  ...
  <div class="element-box">
    ...
    <div class="form-desc">
      Our template includes simple and easily customized typography for headings, body text, lists, and more. To learn more about bootstrap typography classes and settings <a href="https://v4-alpha.getbootstrap.com/content/typography/" target="_blank">click here</a></p>
    </div>
    <h5 class="form-header">
      Headings
    </h5>
    <div class="form-desc">All HTML headings, <code class="highlighter-rouge">&lt;h1&gt;</code> through <code class="highlighter-rouge">&lt;h6&gt;</code>, are available.
    </div>
  ...
  <div class="element-box">
    ...
    <div class="form-desc">Make a paragraph stand out by adding <code class="highlighter-rouge">.lead</code>
    </div>
    <div class="element-box-content">
      <div class="lead">
