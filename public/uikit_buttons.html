...
<html>
  ...
  <div class="element-box">
    ...
    <div class="form-desc">
      Use Bootstrap’s custom button styles for actions in forms, dialogs, and more. Includes support for a handful of contextual variations, sizes, states, and more. Bootstrap includes six predefined button styles, each serving its own semantic purpose. To learn more about buttons in Bootstrap 4 <a href="https://v4-alpha.getbootstrap.com/components/buttons/" target="_blank">click here</a>.
    </div>
    <div class="element-box-content">
      <button class="mr-2 mb-2 btn btn-primary" type="button"> Primary</button><button class="mr-2 mb-2 btn btn-secondary" type="button"> Secondary</button><button class="mr-2 mb-2 btn btn-success" type="button"> Success</button><button class="mr-2 mb-2 btn btn-info" type="button"> Info</button><button class="mr-2 mb-2 btn btn-warning" type="button"> Warning</button><button class="mr-2 mb-2 btn btn-danger" type="button"> Danger</button><button class="mr-2 mb-2 btn btn-white" type="button"> White</button><button class="mr-2 mb-2 btn btn-link" type="button"> Link</button>
    </div>
  </div>
  <div class="element-box">
    <h5 class="form-header">
    ...
    <div class="form-desc">In need of a button, but not the hefty background colors they bring? Replace the default modifier classes with the <code>.btn-outline-*</code> ones to remove all background images and colors on any button.
    </div>
    <div class="element-box-content">
      <button class="mr-2 mb-2 btn btn-outline-primary" type="button"> Primary</button><button class="mr-2 mb-2 btn btn-outline-secondary" type="button"> Secondary</button><button class="mr-2 mb-2 btn btn-outline-success" type="button"> Success</button><button class="mr-2 mb-2 btn btn-outline-info" type="button"> Info</button><button class="mr-2 mb-2 btn btn-outline-warning" type="button"> Warning</button><button class="mr-2 mb-2 btn btn-outline-danger" type="button"> Danger</button>
    </div>
  ...
  <div class="element-box">
    ...
    <div class="form-desc">Fancy larger or smaller buttons? Add <code>.btn-lg</code> or <code>.btn-sm</code> for additional sizes.
    </div>
    <h6 class="form-header">
      Large Buttons
    </h6>
    <div class="element-box-content">
      <button class="mr-2 mb-2 btn btn-primary btn-lg" type="button"> Large button</button><button class="mr-2 mb-2 btn btn-secondary btn-lg" type="button"> Large button</button>
    </div>
    <h6 class="form-header">
      Small Buttons
    </h6>
    <div class="element-box-content">
      <button class="mr-2 mb-2 btn btn-primary btn-sm" type="button"> Small button</button><button class="mr-2 mb-2 btn btn-secondary btn-sm" type="button"> Small button</button>
    </div>
    <h6 class="form-header">
      Rounded Buttons
    </h6>
    <div class="form-desc">To make button rounded add <code>.btn-rounded</code> class.
    </div>
    <div class="element-box-content">
      <button class="mr-2 mb-2 btn btn-primary btn-rounded" type="button"> Rounded button</button><button class="mr-2 mb-2 btn btn-secondary btn-rounded" type="button"> Rounded button</button>
    </div>
  </div>
</div><!--------------------
